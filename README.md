...
#### Examples: Group-scoped Search

Example: Search issues across a group (including subgroups), newest first
...
Example: Search merge requests in a group
...
Example: Search projects within a group
...
**Parameter Notes for Group Search Tools:**

- **group_id**: Accepts either numeric ID (e.g., `"12345"`) or full path (e.g., `"my-org/platform"`)
- **include_subgroups**: When `true`, includes results from all subgroups within the specified group
- **state** (issues): `"opened"`, `"closed"`, `"all"`
- **state** (merge requests): `"opened"`, `"closed"`, `"locked"`, `"merged"`, `"all"`
- **order_by** (projects): `"created_at"`, `"updated_at"`, `"name"`, `"path"`
- **order_by** (issues): `"created_at"`, `"updated_at"`, `"priority"`, `"due_date"`, `"relative_position"`, `"label_priority"`, `"milestone_due"`, `"popularity"`, `"weight"`
- **order_by** (merge requests): `"created_at"`, `"updated_at"`, `"priority"`, `"label_priority"`, `"milestone_due"`, `"popularity"`
